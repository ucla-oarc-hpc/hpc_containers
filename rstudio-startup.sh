...
echo  "\n\nThis is the Rstudio server container running R 4.2.1 from Rocker"
echo ""
echo "This is a separate R version from the rest of Hoffman2"
echo "When you install libraries from this Rstudio/R, they will be in ~/R/APPTAINER/h2-rstudio_4.2.1"
echo ""
